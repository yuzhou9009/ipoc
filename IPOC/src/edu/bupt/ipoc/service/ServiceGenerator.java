...
public class ServiceGenerator {
	...
	private static final int erlang_value = 220;
...
/*	public PacketService create_PacketService(int _static_bw){
	...
	public static int RandomTotalDataSize()
	{
		int _data_size = 0;
		//TODO tem 
		_data_size = java.util.concurrent.ThreadLocalRandom.current().nextInt(erlang_value * Service.TIME_STEP * 10000 - 200000, erlang_value * Service.TIME_STEP * 10000 + 200000);
