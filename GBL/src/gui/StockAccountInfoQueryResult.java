...
public class StockAccountInfoQueryResult extends JPanel {
	...
	JScrollPane jsp;
	public JPanel singleStockAccount;
		...
		result_tb.addKeyListener(new KeyListener(){
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode() == KeyEvent.VK_ESCAPE)
				{
					...
					int row_count = result_tb.getSelectedRow();
					if(row_count >= 0)
					System.out.println(""+saifqrl.get(row_count).accountID);
					e.consume();
					
					//JPanel singleStockAccount = new SingleStockAccountInfoPanel();
